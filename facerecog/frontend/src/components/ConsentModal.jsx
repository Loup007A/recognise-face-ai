        ...
        <div style={styles.body}>
          ...
          <div style={styles.section}>
            ...
            <div style={styles.highlight}>
              ...
              • <strong>Empreinte vocale (optionnelle)</strong> — signature spectrale de votre voix, sous forme de valeurs numériques<br />
              • <strong>Identifiant biométrique d'appareil (optionnel)</strong> — via Touch ID / Face ID / Windows Hello (WebAuthn). Votre empreinte digitale réelle ne quitte jamais votre appareil ; seule une clé cryptographique est transmise<br />
              • <strong>Nom</strong>, <strong>date de naissance</strong>, <strong>âge calculé</strong>, <strong>ethnie</strong> (optionnel)<br />
              • <strong>Logs d'utilisation</strong> anonymisés (date, action effectuée, méthode utilisée)
            </div>
          </div>
          ...
          <label style={{
            ...
            <span style={styles.checkLabel}>
              Je consens au <strong>traitement de mes données biométriques</strong> (visage, et le cas échéant voix et/ou empreinte digitale)
